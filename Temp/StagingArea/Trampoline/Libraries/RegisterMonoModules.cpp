...
extern "C"
{
    ...
    const char*         UnityIPhoneRuntimeVersion = "5.3.5f1";
...
#define DLL_EXPORT
    ...
    extern gpointer*    mono_aot_module_EasyAR_Unity_info; // EasyAR.Unity.dll
    ...
    DECL_USER_FUNC(_CWebViewPlugin_Init);
    DECL_USER_FUNC(_CWebViewPlugin_Destroy);
    DECL_USER_FUNC(_CWebViewPlugin_SetMargins);
    DECL_USER_FUNC(_CWebViewPlugin_SetVisibility);
    DECL_USER_FUNC(_CWebViewPlugin_LoadURL);
    DECL_USER_FUNC(_CWebViewPlugin_EvaluateJS);
    DECL_USER_FUNC(_CWebViewPlugin_GoBack);
    DECL_USER_FUNC(_CWebViewPlugin_GoForward);
    DECL_USER_FUNC(_CWebViewPlugin_SetFrame);
    DECL_USER_FUNC(ezarGetProjectionGL);
    DECL_USER_FUNC(ezarGetPoseGL);
    DECL_USER_FUNC(ezarSetAssetPath);
    DECL_USER_FUNC(ezarRegisterLogFunc);
    DECL_USER_FUNC(ezarBase_IsValid);
    DECL_USER_FUNC(ezarOnResume);
    DECL_USER_FUNC(ezarOnPause);
    DECL_USER_FUNC(ezarNativeInit);
    DECL_USER_FUNC(ezarversionString);
    DECL_USER_FUNC(ezarCreate_Augmenter);
    DECL_USER_FUNC(ezarDestory_Augmenter);
    DECL_USER_FUNC(ezarAugmenter_newFrame);
    DECL_USER_FUNC(ezarAugmenter_newFrameFromBarCodeScanner);
    DECL_USER_FUNC(ezarAugmenter_drawVideoBackground);
    DECL_USER_FUNC(ezarAugmenter_getVideoBackgroundTextureSize);
    DECL_USER_FUNC(ezarAugmenter_getVideoBackgroundTextureFormat);
    DECL_USER_FUNC(ezarAugmenter_setVideoBackgroundTextureID);
    DECL_USER_FUNC(ezarAugmenter_getID);
    DECL_USER_FUNC(ezarAugmenter_addVideoBackgroundTextureID);
    DECL_USER_FUNC(ezarAugmenter_clearVideoBackgroundTextureID);
    DECL_USER_FUNC(ezarAugmenter_getRenderingFlag);
    DECL_USER_FUNC(ezarCreate_CameraCalibration);
    DECL_USER_FUNC(ezarDestory_CameraCalibration);
    DECL_USER_FUNC(ezarCameraCalibration_getSize);
    DECL_USER_FUNC(ezarCameraCalibration_getFocalLength);
    DECL_USER_FUNC(ezarCameraCalibration_getPrincipalPoint);
    DECL_USER_FUNC(ezarCameraCalibration_getDistortionParameters);
    DECL_USER_FUNC(ezarCreate_CameraDevice);
    DECL_USER_FUNC(ezarDestory_CameraDevice);
    DECL_USER_FUNC(ezarCameraDevice_start);
    DECL_USER_FUNC(ezarCameraDevice_stop);
    DECL_USER_FUNC(ezarCameraDevice_open);
    DECL_USER_FUNC(ezarCameraDevice_close);
    DECL_USER_FUNC(ezarCameraDevice_isOpened);
    DECL_USER_FUNC(ezarCameraDevice_getFrameRate);
    DECL_USER_FUNC(ezarCameraDevice_getNumSupportedFrameRate);
    DECL_USER_FUNC(ezarCameraDevice_getSupportedFrameRate);
    DECL_USER_FUNC(ezarCameraDevice_setFrameRate);
    DECL_USER_FUNC(ezarCameraDevice_getSize);
    DECL_USER_FUNC(ezarCameraDevice_getNumSupportedSize);
    DECL_USER_FUNC(ezarCameraDevice_getSupportedSize);
    DECL_USER_FUNC(ezarCameraDevice_setSize);
    DECL_USER_FUNC(ezarCameraDevice_getCameraCalibration);
    DECL_USER_FUNC(ezarCameraDevice_setFlashTorchMode);
    DECL_USER_FUNC(ezarCameraDevice_setFocusMode);
    DECL_USER_FUNC(ezarCreate_Frame);
    DECL_USER_FUNC(ezarDestory_Frame);
    DECL_USER_FUNC(ezarFrame_getTimeStamp);
    DECL_USER_FUNC(ezarFrame_getIndex);
    DECL_USER_FUNC(ezarFrame_images);
    DECL_USER_FUNC(ezarFrame_targets);
    DECL_USER_FUNC(ezarFrame_text);
    DECL_USER_FUNC(ezarCreate_Image);
    DECL_USER_FUNC(ezarDestory_Image);
    DECL_USER_FUNC(ezarImage_getWidth);
    DECL_USER_FUNC(ezarImage_getHeight);
    DECL_USER_FUNC(ezarImage_getStride);
    DECL_USER_FUNC(ezarImage_getFormat);
    DECL_USER_FUNC(ezarImage_getPixels);
    DECL_USER_FUNC(ezarCreate_ImageTarget);
    DECL_USER_FUNC(ezarDestory_ImageTarget);
    DECL_USER_FUNC(ezarImageTarget_getSize);
    DECL_USER_FUNC(ezarImageTarget_setSize);
    DECL_USER_FUNC(ezarImageTarget_load);
    DECL_USER_FUNC(ezarCreate_Target);
    DECL_USER_FUNC(ezarDestory_Target);
    DECL_USER_FUNC(ezarTarget_getId);
    DECL_USER_FUNC(ezarTarget_getName);
    DECL_USER_FUNC(ezarTarget_getUid);
    DECL_USER_FUNC(ezarTarget_metaData);
    DECL_USER_FUNC(ezarTarget_load);
    DECL_USER_FUNC(ezarTarget_images);
    DECL_USER_FUNC(ezarCreate_TargetList);
    DECL_USER_FUNC(ezarDestory_TargetList);
    DECL_USER_FUNC(ezarTargetList_load);
    DECL_USER_FUNC(ezarTargetList_size);
    DECL_USER_FUNC(ezarTargetList_at);
    DECL_USER_FUNC(ezarCreate_AugmentedTargetList);
    DECL_USER_FUNC(ezarDestory_AugmentedTargetList);
    DECL_USER_FUNC(ezarAugmentedTargetList_size);
    DECL_USER_FUNC(ezarAugmentedTargetList_at);
    DECL_USER_FUNC(ezarCreate_ImageList);
    DECL_USER_FUNC(ezarDestory_ImageList);
    DECL_USER_FUNC(ezarImageList_size);
    DECL_USER_FUNC(ezarImageList_at);
    DECL_USER_FUNC(ezarCreate_AugmentedTarget);
    DECL_USER_FUNC(ezarDestory_AugmentedTarget);
    DECL_USER_FUNC(ezarAugmentedTarget_status);
    DECL_USER_FUNC(ezarAugmentedTarget_target);
    DECL_USER_FUNC(ezarAugmentedTarget_pose);
    DECL_USER_FUNC(ezarCreate_ImageTracker);
    DECL_USER_FUNC(ezarDestory_ImageTracker);
    DECL_USER_FUNC(ezarImageTracker_attachCamera);
    DECL_USER_FUNC(ezarImageTracker_detachCamera);
    DECL_USER_FUNC(ezarImageTracker_loadTarget);
    DECL_USER_FUNC(ezarImageTracker_loadTargetBlocked);
    DECL_USER_FUNC(ezarImageTracker_unloadTarget);
    DECL_USER_FUNC(ezarImageTracker_unloadTargetBlocked);
    DECL_USER_FUNC(ezarImageTracker_start);
    DECL_USER_FUNC(ezarImageTracker_stop);
    DECL_USER_FUNC(ezarImageTracker_targets);
    DECL_USER_FUNC(ezarCreate_TargetLoadCallBackUnity);
    DECL_USER_FUNC(ezarDestory_TargetLoadCallBackUnity);
    DECL_USER_FUNC(ezarImageTracker_checkCallBack);
    DECL_USER_FUNC(ezarImageTracker_setCallBackThread);
    DECL_USER_FUNC(ezarCreate_BarCodeScanner);
    DECL_USER_FUNC(ezarDestory_BarCodeScanner);
    DECL_USER_FUNC(ezarBarCodeScanner_attachCamera);
    DECL_USER_FUNC(ezarBarCodeScanner_detachCamera);
    DECL_USER_FUNC(ezarBarCodeScanner_start);
    DECL_USER_FUNC(ezarBarCodeScanner_stop);
    DECL_USER_FUNC(ezarCreate_VideoPlayer);
    DECL_USER_FUNC(ezarDestory_VideoPlayer);
    DECL_USER_FUNC(ezarVideoPlayer_setRenderTexture);
    DECL_USER_FUNC(ezarVideoPlayer_setVideoType);
    DECL_USER_FUNC(ezarVideoPlayer_open);
    DECL_USER_FUNC(ezarVideoPlayer_close);
    DECL_USER_FUNC(ezarVideoPlayer_play);
    DECL_USER_FUNC(ezarVideoPlayer_stop);
    DECL_USER_FUNC(ezarVideoPlayer_pause);
    DECL_USER_FUNC(ezarVideoPlayer_updateFrame);
    DECL_USER_FUNC(ezarVideoPlayer_duration);
    DECL_USER_FUNC(ezarVideoPlayer_currentPosition);
    DECL_USER_FUNC(ezarVideoPlayer_seek);
    DECL_USER_FUNC(ezarVideoPlayer_size);
    DECL_USER_FUNC(ezarVideoPlayer_volume);
    DECL_USER_FUNC(ezarVideoPlayer_setVolume);
    DECL_USER_FUNC(ezarCreate_VideoPlayerCallBackUnity);
    DECL_USER_FUNC(ezarVideoPlayer_checkCallBack);
    DECL_USER_FUNC(ezarVideoPlayer_setCallBackThread);
    DECL_USER_FUNC(ezarDestory_VideoPlayerCallBackUnity);
    DECL_USER_FUNC(ezarCast_Target2ImageTarget);
}
DLL_EXPORT void RegisterMonoModules()
{
    ...
    mono_aot_register_module(mono_aot_module_EasyAR_Unity_info);
    ...
    REGISTER_USER_FUNC(_CWebViewPlugin_Init);
    REGISTER_USER_FUNC(_CWebViewPlugin_Destroy);
    REGISTER_USER_FUNC(_CWebViewPlugin_SetMargins);
    REGISTER_USER_FUNC(_CWebViewPlugin_SetVisibility);
    REGISTER_USER_FUNC(_CWebViewPlugin_LoadURL);
    REGISTER_USER_FUNC(_CWebViewPlugin_EvaluateJS);
    REGISTER_USER_FUNC(_CWebViewPlugin_GoBack);
    REGISTER_USER_FUNC(_CWebViewPlugin_GoForward);
    REGISTER_USER_FUNC(_CWebViewPlugin_SetFrame);
    REGISTER_USER_FUNC(ezarGetProjectionGL);
    REGISTER_USER_FUNC(ezarGetPoseGL);
    REGISTER_USER_FUNC(ezarSetAssetPath);
    REGISTER_USER_FUNC(ezarRegisterLogFunc);
    REGISTER_USER_FUNC(ezarBase_IsValid);
    REGISTER_USER_FUNC(ezarOnResume);
    REGISTER_USER_FUNC(ezarOnPause);
    REGISTER_USER_FUNC(ezarNativeInit);
    REGISTER_USER_FUNC(ezarversionString);
    REGISTER_USER_FUNC(ezarCreate_Augmenter);
    REGISTER_USER_FUNC(ezarDestory_Augmenter);
    REGISTER_USER_FUNC(ezarAugmenter_newFrame);
    REGISTER_USER_FUNC(ezarAugmenter_newFrameFromBarCodeScanner);
    REGISTER_USER_FUNC(ezarAugmenter_drawVideoBackground);
    REGISTER_USER_FUNC(ezarAugmenter_getVideoBackgroundTextureSize);
    REGISTER_USER_FUNC(ezarAugmenter_getVideoBackgroundTextureFormat);
    REGISTER_USER_FUNC(ezarAugmenter_setVideoBackgroundTextureID);
    REGISTER_USER_FUNC(ezarAugmenter_getID);
    REGISTER_USER_FUNC(ezarAugmenter_addVideoBackgroundTextureID);
    REGISTER_USER_FUNC(ezarAugmenter_clearVideoBackgroundTextureID);
    REGISTER_USER_FUNC(ezarAugmenter_getRenderingFlag);
    REGISTER_USER_FUNC(ezarCreate_CameraCalibration);
    REGISTER_USER_FUNC(ezarDestory_CameraCalibration);
    REGISTER_USER_FUNC(ezarCameraCalibration_getSize);
    REGISTER_USER_FUNC(ezarCameraCalibration_getFocalLength);
    REGISTER_USER_FUNC(ezarCameraCalibration_getPrincipalPoint);
    REGISTER_USER_FUNC(ezarCameraCalibration_getDistortionParameters);
    REGISTER_USER_FUNC(ezarCreate_CameraDevice);
    REGISTER_USER_FUNC(ezarDestory_CameraDevice);
    REGISTER_USER_FUNC(ezarCameraDevice_start);
    REGISTER_USER_FUNC(ezarCameraDevice_stop);
    REGISTER_USER_FUNC(ezarCameraDevice_open);
    REGISTER_USER_FUNC(ezarCameraDevice_close);
    REGISTER_USER_FUNC(ezarCameraDevice_isOpened);
    REGISTER_USER_FUNC(ezarCameraDevice_getFrameRate);
    REGISTER_USER_FUNC(ezarCameraDevice_getNumSupportedFrameRate);
    REGISTER_USER_FUNC(ezarCameraDevice_getSupportedFrameRate);
    REGISTER_USER_FUNC(ezarCameraDevice_setFrameRate);
    REGISTER_USER_FUNC(ezarCameraDevice_getSize);
    REGISTER_USER_FUNC(ezarCameraDevice_getNumSupportedSize);
    REGISTER_USER_FUNC(ezarCameraDevice_getSupportedSize);
    REGISTER_USER_FUNC(ezarCameraDevice_setSize);
    REGISTER_USER_FUNC(ezarCameraDevice_getCameraCalibration);
    REGISTER_USER_FUNC(ezarCameraDevice_setFlashTorchMode);
    REGISTER_USER_FUNC(ezarCameraDevice_setFocusMode);
    REGISTER_USER_FUNC(ezarCreate_Frame);
    REGISTER_USER_FUNC(ezarDestory_Frame);
    REGISTER_USER_FUNC(ezarFrame_getTimeStamp);
    REGISTER_USER_FUNC(ezarFrame_getIndex);
    REGISTER_USER_FUNC(ezarFrame_images);
    REGISTER_USER_FUNC(ezarFrame_targets);
    REGISTER_USER_FUNC(ezarFrame_text);
    REGISTER_USER_FUNC(ezarCreate_Image);
    REGISTER_USER_FUNC(ezarDestory_Image);
    REGISTER_USER_FUNC(ezarImage_getWidth);
    REGISTER_USER_FUNC(ezarImage_getHeight);
    REGISTER_USER_FUNC(ezarImage_getStride);
    REGISTER_USER_FUNC(ezarImage_getFormat);
    REGISTER_USER_FUNC(ezarImage_getPixels);
    REGISTER_USER_FUNC(ezarCreate_ImageTarget);
    REGISTER_USER_FUNC(ezarDestory_ImageTarget);
    REGISTER_USER_FUNC(ezarImageTarget_getSize);
    REGISTER_USER_FUNC(ezarImageTarget_setSize);
    REGISTER_USER_FUNC(ezarImageTarget_load);
    REGISTER_USER_FUNC(ezarCreate_Target);
    REGISTER_USER_FUNC(ezarDestory_Target);
    REGISTER_USER_FUNC(ezarTarget_getId);
    REGISTER_USER_FUNC(ezarTarget_getName);
    REGISTER_USER_FUNC(ezarTarget_getUid);
    REGISTER_USER_FUNC(ezarTarget_metaData);
    REGISTER_USER_FUNC(ezarTarget_load);
    REGISTER_USER_FUNC(ezarTarget_images);
    REGISTER_USER_FUNC(ezarCreate_TargetList);
    REGISTER_USER_FUNC(ezarDestory_TargetList);
    REGISTER_USER_FUNC(ezarTargetList_load);
    REGISTER_USER_FUNC(ezarTargetList_size);
    REGISTER_USER_FUNC(ezarTargetList_at);
    REGISTER_USER_FUNC(ezarCreate_AugmentedTargetList);
    REGISTER_USER_FUNC(ezarDestory_AugmentedTargetList);
    REGISTER_USER_FUNC(ezarAugmentedTargetList_size);
    REGISTER_USER_FUNC(ezarAugmentedTargetList_at);
    REGISTER_USER_FUNC(ezarCreate_ImageList);
    REGISTER_USER_FUNC(ezarDestory_ImageList);
    REGISTER_USER_FUNC(ezarImageList_size);
    REGISTER_USER_FUNC(ezarImageList_at);
    REGISTER_USER_FUNC(ezarCreate_AugmentedTarget);
    REGISTER_USER_FUNC(ezarDestory_AugmentedTarget);
    REGISTER_USER_FUNC(ezarAugmentedTarget_status);
    REGISTER_USER_FUNC(ezarAugmentedTarget_target);
    REGISTER_USER_FUNC(ezarAugmentedTarget_pose);
    REGISTER_USER_FUNC(ezarCreate_ImageTracker);
    REGISTER_USER_FUNC(ezarDestory_ImageTracker);
    REGISTER_USER_FUNC(ezarImageTracker_attachCamera);
    REGISTER_USER_FUNC(ezarImageTracker_detachCamera);
    REGISTER_USER_FUNC(ezarImageTracker_loadTarget);
    REGISTER_USER_FUNC(ezarImageTracker_loadTargetBlocked);
    REGISTER_USER_FUNC(ezarImageTracker_unloadTarget);
    REGISTER_USER_FUNC(ezarImageTracker_unloadTargetBlocked);
    REGISTER_USER_FUNC(ezarImageTracker_start);
    REGISTER_USER_FUNC(ezarImageTracker_stop);
    REGISTER_USER_FUNC(ezarImageTracker_targets);
    REGISTER_USER_FUNC(ezarCreate_TargetLoadCallBackUnity);
    REGISTER_USER_FUNC(ezarDestory_TargetLoadCallBackUnity);
    REGISTER_USER_FUNC(ezarImageTracker_checkCallBack);
    REGISTER_USER_FUNC(ezarImageTracker_setCallBackThread);
    REGISTER_USER_FUNC(ezarCreate_BarCodeScanner);
    REGISTER_USER_FUNC(ezarDestory_BarCodeScanner);
    REGISTER_USER_FUNC(ezarBarCodeScanner_attachCamera);
    REGISTER_USER_FUNC(ezarBarCodeScanner_detachCamera);
    REGISTER_USER_FUNC(ezarBarCodeScanner_start);
    REGISTER_USER_FUNC(ezarBarCodeScanner_stop);
    REGISTER_USER_FUNC(ezarCreate_VideoPlayer);
    REGISTER_USER_FUNC(ezarDestory_VideoPlayer);
    REGISTER_USER_FUNC(ezarVideoPlayer_setRenderTexture);
    REGISTER_USER_FUNC(ezarVideoPlayer_setVideoType);
    REGISTER_USER_FUNC(ezarVideoPlayer_open);
    REGISTER_USER_FUNC(ezarVideoPlayer_close);
    REGISTER_USER_FUNC(ezarVideoPlayer_play);
    REGISTER_USER_FUNC(ezarVideoPlayer_stop);
    REGISTER_USER_FUNC(ezarVideoPlayer_pause);
    REGISTER_USER_FUNC(ezarVideoPlayer_updateFrame);
    REGISTER_USER_FUNC(ezarVideoPlayer_duration);
    REGISTER_USER_FUNC(ezarVideoPlayer_currentPosition);
    REGISTER_USER_FUNC(ezarVideoPlayer_seek);
    REGISTER_USER_FUNC(ezarVideoPlayer_size);
    REGISTER_USER_FUNC(ezarVideoPlayer_volume);
    REGISTER_USER_FUNC(ezarVideoPlayer_setVolume);
    REGISTER_USER_FUNC(ezarCreate_VideoPlayerCallBackUnity);
    REGISTER_USER_FUNC(ezarVideoPlayer_checkCallBack);
    REGISTER_USER_FUNC(ezarVideoPlayer_setCallBackThread);
    REGISTER_USER_FUNC(ezarDestory_VideoPlayerCallBackUnity);
    REGISTER_USER_FUNC(ezarCast_Target2ImageTarget);
}
